...
var file_sdk_stream_aggregated_price_v1_request_proto_rawDesc = string([]byte{
...
var (
	...
	file_sdk_stream_aggregated_price_v1_request_proto_rawDescData []byte
)
...
func file_sdk_stream_aggregated_price_v1_request_proto_rawDescGZIP() []byte {
	file_sdk_stream_aggregated_price_v1_request_proto_rawDescOnce.Do(func() {
		file_sdk_stream_aggregated_price_v1_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sdk_stream_aggregated_price_v1_request_proto_rawDesc), len(file_sdk_stream_aggregated_price_v1_request_proto_rawDesc)))
	})
...
var file_sdk_stream_aggregated_price_v1_request_proto_goTypes = []any{
...
func file_sdk_stream_aggregated_price_v1_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sdk_stream_aggregated_price_v1_request_proto_rawDesc), len(file_sdk_stream_aggregated_price_v1_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
