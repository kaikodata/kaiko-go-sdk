...
var file_sdk_core_source_proto_rawDesc = string([]byte{
...
var (
	...
	file_sdk_core_source_proto_rawDescData []byte
)

func file_sdk_core_source_proto_rawDescGZIP() []byte {
	file_sdk_core_source_proto_rawDescOnce.Do(func() {
		file_sdk_core_source_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sdk_core_source_proto_rawDesc), len(file_sdk_core_source_proto_rawDesc)))
	})
	return file_sdk_core_source_proto_rawDescData
}

var file_sdk_core_source_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sdk_core_source_proto_goTypes = []any{
...
func file_sdk_core_source_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sdk_core_source_proto_rawDesc), len(file_sdk_core_source_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
