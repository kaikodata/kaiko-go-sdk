...
var file_sdk_sdk_proto_goTypes = []any{
	...
	(*aggregated_quote_v2.StreamAggregatedQuoteResponseV2)(nil),                               // 18: kaikosdk.StreamAggregatedQuoteResponseV2
	(*aggregated_price_v1.StreamAggregatedPriceResponseV1)(nil),                               // 19: kaikosdk.StreamAggregatedPriceResponseV1
	(*aggregates_ohlcv_v1.StreamAggregatesOHLCVResponseV1)(nil),                               // 20: kaikosdk.StreamAggregatesOHLCVResponseV1
	(*trades_v1.StreamTradesResponseV1)(nil),                                                  // 21: kaikosdk.StreamTradesResponseV1
	(*aggregates_vwap_v1.StreamAggregatesVWAPResponseV1)(nil),                                 // 22: kaikosdk.StreamAggregatesVWAPResponseV1
	(*index_v1.StreamIndexServiceResponseV1)(nil),                                             // 23: kaikosdk.StreamIndexServiceResponseV1
	(*index_multi_assets_v1.StreamIndexMultiAssetsServiceResponseV1)(nil),                     // 24: kaikosdk.StreamIndexMultiAssetsServiceResponseV1
	(*market_update_v1.StreamMarketUpdateResponseV1)(nil),                                     // 25: kaikosdk.StreamMarketUpdateResponseV1
	(*aggregates_spot_exchange_rate_v2.StreamAggregatesSpotExchangeRateV2ResponseV1)(nil),     // 26: kaikosdk.StreamAggregatesSpotExchangeRateV2ResponseV1
	(*aggregates_direct_exchange_rate_v2.StreamAggregatesDirectExchangeRateV2ResponseV1)(nil), // 27: kaikosdk.StreamAggregatesDirectExchangeRateV2ResponseV1
	(*index_forex_rate_v1.StreamIndexForexRateServiceResponseV1)(nil),                         // 28: kaikosdk.StreamIndexForexRateServiceResponseV1
	(*derivatives_instrument_metrics_v1.StreamDerivativesInstrumentMetricsResponseV1)(nil),    // 29: kaikosdk.StreamDerivativesInstrumentMetricsResponseV1
	(*iv_svi_parameters_v1.StreamIvSviParametersResponseV1)(nil),                              // 30: kaikosdk.StreamIvSviParametersResponseV1
	(*exotic_indices_v1.StreamExoticIndicesServiceResponseV1)(nil),                            // 31: kaikosdk.StreamExoticIndicesServiceResponseV1
	(*orderbookl2_v1.StreamOrderBookL2ResponseV1)(nil),                                        // 32: kaikosdk.StreamOrderBookL2ResponseV1
	(*aggregated_state_price_v1.StreamAggregatedStatePriceResponseV1)(nil),                    // 33: kaikosdk.StreamAggregatedStatePriceResponseV1
	(*constant_duration_indices_v1.StreamConstantDurationIndicesServiceResponseV1)(nil),       // 34: kaikosdk.StreamConstantDurationIndicesServiceResponseV1
}
var file_sdk_sdk_proto_depIdxs = []int32{
	...
	18, // 18: kaikosdk.StreamAggregatedQuoteServiceV2.Subscribe:output_type -> kaikosdk.StreamAggregatedQuoteResponseV2
	19, // 19: kaikosdk.StreamAggregatedPriceServiceV1.Subscribe:output_type -> kaikosdk.StreamAggregatedPriceResponseV1
	20, // 20: kaikosdk.StreamAggregatesOHLCVServiceV1.Subscribe:output_type -> kaikosdk.StreamAggregatesOHLCVResponseV1
	21, // 21: kaikosdk.StreamTradesServiceV1.Subscribe:output_type -> kaikosdk.StreamTradesResponseV1
	22, // 22: kaikosdk.StreamAggregatesVWAPServiceV1.Subscribe:output_type -> kaikosdk.StreamAggregatesVWAPResponseV1
	23, // 23: kaikosdk.StreamIndexServiceV1.Subscribe:output_type -> kaikosdk.StreamIndexServiceResponseV1
	24, // 24: kaikosdk.StreamIndexMultiAssetsServiceV1.Subscribe:output_type -> kaikosdk.StreamIndexMultiAssetsServiceResponseV1
	25, // 25: kaikosdk.StreamMarketUpdateServiceV1.Subscribe:output_type -> kaikosdk.StreamMarketUpdateResponseV1
	26, // 26: kaikosdk.StreamAggregatesSpotExchangeRateV2ServiceV1.Subscribe:output_type -> kaikosdk.StreamAggregatesSpotExchangeRateV2ResponseV1
	27, // 27: kaikosdk.StreamAggregatesSpotDirectExchangeRateV2ServiceV1.Subscribe:output_type -> kaikosdk.StreamAggregatesDirectExchangeRateV2ResponseV1
	28, // 28: kaikosdk.StreamIndexForexRateServiceV1.Subscribe:output_type -> kaikosdk.StreamIndexForexRateServiceResponseV1
	29, // 29: kaikosdk.StreamDerivativesInstrumentMetricsServiceV1.Subscribe:output_type -> kaikosdk.StreamDerivativesInstrumentMetricsResponseV1
	30, // 30: kaikosdk.StreamIvSviParametersServiceV1.Subscribe:output_type -> kaikosdk.StreamIvSviParametersResponseV1
	31, // 31: kaikosdk.StreamExoticIndicesServiceV1.Subscribe:output_type -> kaikosdk.StreamExoticIndicesServiceResponseV1
	32, // 32: kaikosdk.StreamOrderbookL2ServiceV1.Subscribe:output_type -> kaikosdk.StreamOrderBookL2ResponseV1
	33, // 33: kaikosdk.StreamAggregatedStatePriceServiceV1.Subscribe:output_type -> kaikosdk.StreamAggregatedStatePriceResponseV1
	32, // 34: kaikosdk.StreamOrderbookL2ReplayServiceV1.Subscribe:output_type -> kaikosdk.StreamOrderBookL2ResponseV1
	34, // 35: kaikosdk.StreamConstantDurationIndicesServiceV1.Subscribe:output_type -> kaikosdk.StreamConstantDurationIndicesServiceResponseV1
